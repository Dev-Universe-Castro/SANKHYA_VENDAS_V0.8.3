      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Monitor de API Sankhya</p>
            </div>
          </div>
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-white font-medium">{new Date(tokenInfo.createdAt).toLocaleString('pt-BR')}</p>
                  </div>
                  <div className="space-y-1">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Últimas 50 requisições para a API Sankhya</CardDescription>
          </CardHeader>
          <CardContent>
